...
SECRET_KEY = "django-insecure-+pha7q_e=@%qel)xyhk#n1(av+h8i1k=4w4ee4t#-6@6q*ig&i"
...
SIMPLE_JWT = {
    ...
    'TOKEN_BACKEND': 'rest_framework_simplejwt.token_blacklist.backends.BlacklistTokenBackend',
}
